...
# AgentState.working_df. Without this, interrupts fail with
# "Type is not msgpack serializable: DataFrame" the first time a checkpoint
# is written (which happens just before the target_selector interrupt).
